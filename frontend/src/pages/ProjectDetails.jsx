      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <span className="bg-blue-200/50 text-blue-700 dark:bg-blue-600/20 dark:text-blue-400 px-3 py-1 rounded-full text-sm">AI/ML</span>
            <span className="text-gray-500 dark:text-gray-400">•</span>
            <span className="text-gray-500 dark:text-gray-400">Created Sep 10, 2024</span>
          </div>
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">AI Study Assistant</h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg">An intelligent companion to help students optimize their learning process</p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-400 mb-3">The Problem</h3>
                  <p className="text-gray-600 dark:text-gray-300">Students struggle with personalized study plans and often don't know how to optimize their learning efficiency based on their individual strengths and weaknesses.</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-green-600 dark:text-green-400 mb-3">The Solution</h3>
                  <p className="text-gray-600 dark:text-gray-300">An AI-powered mobile app that analyzes study patterns, creates personalized learning schedules, and provides adaptive recommendations to improve academic performance.</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-purple-600 dark:text-purple-400 mb-3">Unique Approach</h3>
                  <p className="text-gray-600 dark:text-gray-300">Uses machine learning to adapt in real-time based on quiz performance, study session data, and learning preferences to create truly personalized experiences.</p>
                </div>
              </div>
            </motion.div>
                ...
                {milestones.map((milestone, index) => (
                  <div key={milestone.id} className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">{milestone.date}</p>
                    </div>
                    <span className={`px-3 py-1 rounded-full text-sm capitalize font-semibold ${
                      milestone.status === 'completed' 
          ...
          <div className="space-y-8">
            ...
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Project Stats</h3>
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Progress</span>
                  <span className="text-gray-900 dark:text-white font-semibold">50%</span>
                </div>
                ...
                <div className="flex justify-between pt-2">
                  ...
                  <span className="text-gray-900 dark:text-white">3 members</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Duration</span>
                  <span className="text-gray-900 dark:text-white">8 weeks</span>
                </div>
                <div className="flex justify-between">
            ...
            <motion.div 
              ...
              className="bg-white/80 border-gray-200 dark:bg-gray-800/50 dark:border-gray-700/50 backdrop-blur-xl rounded-2xl p-6"
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Team</h3>
              <div className="space-y-4">
                {[

      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Join SparkHub</h1>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs mt-1">Looking for mentorship</div>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="text-xs mt-1">Ready to guide others</div>
                </button>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-600 rounded-xl text-white hover:bg-gray-700/50 transition-all">

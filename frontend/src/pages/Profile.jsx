        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <motion.div 
              ...
              className="glass rounded-2xl p-8 sticky top-8"
            >
              {/* Profile Header */}
              <div className="text-center mb-8">
                <div className="relative inline-block">
                  <div className="w-32 h-32 bg-gradient-primary rounded-full flex items-center justify-center text-4xl text-white font-bold mx-auto mb-4">
                    SC
                  </div>
                ...
                <p className="text-gray-400 mb-4">Computer Science Student</p>
              ...
              <div className="space-y-3 mb-8">
                <a href="#" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors p-3 rounded-lg hover:bg-gray-700/50">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <span
                    key={index}
                    className="bg-gradient-primary px-4 py-2 rounded-full text-white font-medium hover:scale-105 transition-transform cursor-pointer"
                  >
                    {skill}
                  </span>
                ))}
            ...
            >
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div key={project.id} className="flex justify-between items-center p-4 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                    <div>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {achievements.map((achievement, index) => (
                  <div key={index} className="text-center p-6 bg-gradient-to-br from-yellow-600/10 to-orange-600/10 rounded-xl border border-yellow-600/20">
                ...
                {[
                  ...
                  <div key={index} className="flex items-center gap-4 p-4 bg-gray-800 rounded-lg">
                    <div className={`w-3 h-3 rounded-full ${
                      ...
                      activity.type === 'milestone' ? 'bg-green-400' : 'bg-orange-400'
                    }`}></div>
